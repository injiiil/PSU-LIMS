					   ...
					   <div class="offset2">
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Custodian change Password</div>
								<div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="dashboard_custodian.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
   ...
   <script>
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						...
						$.jGrowl("Your password is successfully change", { header: 'Change Password Successfully' });
						var delay = 2000;
